        ...
        <section class="hero-wrap style2">
            <div class="container">
                <div class="hero-shape" data-speed="0.06" data-revert="true">
                    <img src="assets/img/hero/hero-shape-4.png" alt="Image"
                        class="hero-shape-one">
                    <img src="assets/img/hero/hero-shape-5.png" alt="Image"
                        class="hero-shape-two">
                    <img src="assets/img/hero/hero-shape-6.png" alt="Image"
                    ...
                    <div class="col-lg-6">
                        <div class="hero-content">
                            <span data-aos="fade-up" data-aos-duration="1000"
                                data-aos-delay="200">SIMPLE, QUICK, SECURED</span>
                            <h1 data-aos="fade-up" data-aos-duration="1000"
                                data-aos-delay="300">Your Local Destination for
                                Currency Exchange</h1>
                            <p data-aos="fade-up" data-aos-duration="1000"
                                data-aos-delay="400">Best India money changer:
                                Your trusted choice for easy currency exchange.
                            ...
                            <div class="hero-btn" data-aos="fade-up"
                                ...
                                <div class="hero-contact" data-aos="fade-up"
                        ...
                        <div class="col-lg-6">
                            <div class="hero-img-wrap">
                                <div class="hero-promo-text bounce">
                                    ...
                                    <h6>150+ <span>Daily Customers</span></h6>
                                </div>
                                <div class="hero-img-one">
                                    <img src="assets/img/hero/hero-img-2.jpg"
                                        alt="Image">
                                </div>
                                <div class="hero-img-two">
                                    <img src="assets/img/hero/hero-img-3.jpg"
                                        alt="Image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6" data-aos="fade-right"
                            ...
                            <div class="about-img-wrap">
                                ...
                                <div class="about-img-one">
                                    <img src="assets/img/about/about-img-5.jpg"
                                        alt="Image">
                                </div>
                                <div class="about-img-two">
                                    <img src="assets/img/about/about-img-6.jpg"
                                        alt="Image">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6" data-aos="fade-left"
                            ...
                            <div class="about-content">
                                <div class="content-title style1">
                                    <span>ABOUT US</span>
                                    <h2>Seamlessly Navigate the World of Money
                                        Exchange, Anytime, Anywhere!</h2>
                                    <p>At Best India Money Changer, we're not
                                        just a currency exchange service. We're
                                        your financial partners, committed to
                                        simplifying money exchange. With years
                                        of expertise, we're your trusted name in
                                        currency exchange.</p>
                                </div>
                                <div class="feature-item-wrap">
                                    <div class="feature-item">
                                        ...
                                        <div class="feature-text">
                                            ...
                                            <p>Swift, secure currency exchanges
                                    ...
                                    <div class="feature-item">
                                        ...
                                        <div class="feature-text">
                                            <h3>Global Currency Experts</h3>
                                            <p>Rely on our expertise in global
                                                currencies for international
                                                financial solutions and advice.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                            <div class="section-title style1 text-center mb-40">
                                <span>SEAMLESS MONEY EXCHANGE</span>
                                <h2>Exchange & Transfer your money from any
                                    currency in a minute</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 order-lg-1 order-md-2 order-2"
                            ...
                            <div class="wh-content">
                                <div class="content-title style1">
                                    ...
                                    <h2>Experience the Best India Money Changer Pvt. Ltd.
                                        Service in trichy</h2>
                                    <p>At Best India Money Changer, we stand out
                                        as your top choice for currency exchange
                                ...
                                <div class="feature-item-wrap">
                                    <div class="feature-item">
                                        ...
                                        <div class="feature-text">
                                            <h3>Exchange at the Current Rate</h3>
                                            <p>Benefit from real-time market
                                    ...
                                    <div class="feature-item">
                                        ...
                                        <div class="feature-text">
                                            <h3>0% Exchange Charge</h3>
                                            <p>Enjoy fee-free, transparent
                                                currency exchange with us.</p>
                                        </div>
                                    </div>
                                    <div class="feature-item">
                                        <div class="feature-icon">
                        ...
                        <div class="col-lg-6 order-lg-2 order-md-1 order-1"
                            ...
                            <div class="row align-items-end">
                                <div class="col-6 wh-img-wrap">
                                    ...
                                    <div class="wh-img">
                                        <img
                                            src="assets/img/why-choose-us/wh-img-4.jpg"
                                            alt="Image">
                                    </div>
                                    <div class="wh-img">
                                        <img
                                            src="assets/img/why-choose-us/wh-img-5.jpg"
                                            alt="Image">
                                    </div>
                                </div>
                                <div class="col-6 wh-img-wrap">
                                    <div class="wh-img">
                                        ...
                                        <img
                                            src="assets/img/why-choose-us/wh-img-6.jpg"
                                            alt="Image">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                            <div class="section-title style1 text-center mb-40">
                                ...
                                <h2>The Most Trusted Currency Exchange Is Here
                                    For Giving Services</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                            <div class="section-title style1 text-center mb-40">
                                ...
                                <h2>Best India Money Changer Pvt. Ltd. Service for all your
                                    needs</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="currency-card">
                                ...
                                <div class="currency-info">
                                    <h3>INR - Indian</h3>
                                    <p>Change Indian Rupees with ease and
                                        transparency.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="currency-card">
                                <div class="currency-flag"><img
                                        src="assets/img/flag/20.png"
                                        alt="Image"></div>
                                <div class="currency-info">
                                    <h3>USD - US</h3>
                                    <p>Trade US Dollars at competitive rates for
                                        your convenience.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="currency-card">
                                ...
                                <div class="currency-info">
                                    <h3>CAD - Canadia</h3>
                                    <p>Change Canadian Dollars with trust and
                                        reliability.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                            <div class="section-title style1 text-center mb-40">
                                ...
                                <h2>More Than 20,000+ Happy Customers Trust Our
                                    Services</h2>
                            </div>
                        </div>
                        <div class="testimonial-slider-two owl-carousel">
                            <div class="testimonial-card style3">
                                ...
                                <p class="client-quote">I visit Best India Money
                                    Change every time I travel. They offer
                                    unbeatable rates and make in-person currency
                                    exchange a breeze!</p>
                            </div>
                            <div class="testimonial-card style3">
                                <div class="client-info-area">
                                ...
                                <p class="client-quote">Best India Money Change
                                    is my neighborhood gem. Their friendly staff
                                    and convenient location have saved me my
                                    traveling times.</p>
                            </div>
                            <div class="testimonial-card style3">
                                <div class="client-info-area">
                                ...
                                <p class="client-quote">I trust Best India Money
                                    Change with my currency exchange needs.
                                    Their physical branch ensures I can always
                                    access reliable service.</p>
                            </div>
                            <div class="testimonial-card style3">
                                <div class="client-info-area">
                                    <div class="client-info-wrap">
                                ...
                                <p class="client-quote">I rely on Best India
                                    Money Change for all my currency exchange
                                    needs. Their team makes every transaction
                                    quick and easy.</p>
                            </div>
                            <div class="testimonial-card style3">
                                <div class="client-info-area">
                                ...
                                <p class="client-quote">Best India Money Change's
                                    in-person service is unmatched. They offer a
                                    personal touch that online services can't
                                    compete with.</p>
                            </div>
                            <div class="testimonial-card style3">
                                <div class="client-info-area">
                                ...
                                <p class="client-quote">I appreciate the
                                    transparency at Best India Money Change's
                                    branch. I know I'm getting a fair deal every
                                    time I exchange my money.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="row pt-100 pb-75">
                    <div class="col-xl-3 col-lg-5 col-md-5 col-sm-6">
                        <div class="footer-widget">
                            ...
                            <p class="comp-desc">
                                Experience the future of currency
                                exchange with Best India money Change.
                                Say goodbye to waiting, and hello to
                                real-time money transfers. Our secure
                                and lightning-fast services connect you
                                to the world's currencies, effortlessly
                                bridging the gap, no matter where you
                                are.
                            </p>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6">
                        ...
                        <div class="col-xl-5 col-lg-7 col-md-6 col-sm-6">
                            <div class="footer-widget">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="copyright-text"><i
                                    class="ri-copyright-line"></i> <span>copyrights
                                    2023 Best India Money Changer Pvt.Ltd</span>.
                                All Rights Reserved By <span><a
                                        href="https://zworktechnology.com/"
                                        target="_blank">Zwork Technology</a></span></p>
                        </div>
                    </div>
                </div>
            </footer>
